(() => {
  ...
  const translations = {
    en: {
      ...
      "hero.title": "Moving images rooted in cinema, built across formats.",
      "hero.secondary": "SHOWREEL",
      "intro.title": "Not an agency. Not just film production. A\u00a0way of looking.",
      "intro.copy": "A compact studio for moving-image across formats. We create films that reveal people, brands and places through the contexts that shape them.",
      ...
      "cine.title": "Films shaped by presence, where context becomes argument.",
      "prod.kicker": "production",
      "prod.title": "Cultural programs, events and programs read through space, people and context.",
      ...
      "comm.title": "Brand and institutional films with cinematic instincts.",
  ...
  const heroManifesto = {
    en: [
      "Moving images rooted in cinema, built across formats.",
      "Stories shaped by context, pace and contrast.",
      "Production guided by place, people and the world around the frame.",
      "A cinematic approach built for the full moving-image spectrum."
    ],
    es: [
